      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-lede">
            From complex sliding-door wardrobes to flat-pack furniture for any room — we
            assemble it all following the manufacturer's instructions.
          </p>
        </div>
        ...
        <h3 className={styles.fullListTitle}>All assembly services</h3>
          ...
          {services.map((service) => (
            <li key={service.id} className={styles.listItem}>
              <div className={styles.listItemHeading}>
                ...
                {service.featured && (
                  <span className={styles.featuredTag}>Speciality</span>
                )}
              </div>
